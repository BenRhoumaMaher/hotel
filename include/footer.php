...
<script src="<?php echo ROOT; ?>/js/jquery-migrate-3.0.1.min.js"></script>
<script src="<?php echo ROOT; ?>/js/popper.min.js"></script>
<script src="<?php echo ROOT; ?>/js/bootstrap.min.js"></script>
<script src="<?php echo ROOT; ?>/js/jquery.easing.1.3.js"></script>
<script src="<?php echo ROOT; ?>/js/jquery.waypoints.min.js"></script>
<script src="<?php echo ROOT; ?>/js/jquery.stellar.min.js"></script>
<script src="<?php echo ROOT; ?>/js/jquery.animateNumber.min.js"></script>
<script src="<?php echo ROOT; ?>/js/bootstrap-datepicker.js"></script>
<script src="<?php echo ROOT; ?>/js/jquery.timepicker.min.js"></script>
<script src="<?php echo ROOT; ?>/js/owl.carousel.min.js"></script>
<script src="<?php echo ROOT; ?>/js/jquery.magnific-popup.min.js"></script>
<script src="<?php echo ROOT; ?>/js/scrollax.min.js"></script>
<script
    src="<?php echo ROOT; ?>/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false">
</script>
<script src="<?php echo ROOT; ?>/js/google-map.js"></script>
