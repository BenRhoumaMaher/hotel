    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
            ...
            <div class="col-md-7 ftco-animate">
                <h2 class="subheading text-grey">Welcome to Maher's Hotel</h2>
                <h1 class="mb-4">Rent an appartment for your vacation</h1>
                <p>
                    <a href="<?php echo ROOT; ?>/about.php" class="btn btn-primary">Learn more</a>
                    <a href="<?php echo ROOT; ?>/contact.php" class="btn btn-white">Contact us</a>
                </p>
            </div>
        </div>
    </div>
...
<section class="ftco-section ftco-services">
    <div class="container">
        <div class="row">
            <?php foreach($fetch as $hotel) : ?>
            <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
                <div class="d-block services-wrap text-center">
                    <div class="img"
                        style="background-image: url(<?php echo HOTELSIMAGES; ?>/<?php echo $hotel->image; ?>)"></div>
                    <div class="media-body py-4 px-3">
                        ...
                        <p>
                            <a href="rooms.php?id=<?php echo $hotel->id; ?>" class="btn btn-primary">View rooms</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6">
                <div class="room-wrap d-md-flex">
                    <a href="#" class="img"
                        style="background-image: url(<?php echo ROOMSIMAGES; ?>/<?php echo $room->image; ?>)"></a>
                    <div class="half left-arrow d-flex align-items-center">
                        <div class="text p-4 p-xl-5 text-center">
                            ...
                            <h3 class="mb-3"><a
                                    href="<?php echo ROOT; ?>/rooms/room-single.php?id=<?php echo $room->id; ?>">Suite
                                    Room</a></h3>
                            ...
                            <p class="pt-1">
                                <a href="<?php echo ROOT; ?>/rooms/room-single.php?id=<?php echo $room->id; ?>"
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-9 text-center">
                ...
                <p class="mb-0">
                    <a href="<?php echo ROOT; ?>/about.php" class="btn btn-primary px-4 py-3">Learn More</a>
                    <a href="<?php echo ROOT; ?>/contact.php" class="btn btn-white px-4 py-3">Contact us</a>
                </p>
            </div>
        </div>
    </div>
